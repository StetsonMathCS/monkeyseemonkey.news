    ...
    return (
        ...
        <div className = "container mx-auto bg-blue-darkest" >
                ...
                <div id="about">
                    ...
                    <div className = "positionMe"><img src = {typePad} height = "42" width = "30" alt = "arrow" className = "logoStat"></img> <h1 className = "text text-blue-lighter">{String(this.state.TypePad * 10).slice(0,5)}</h1></div>
                    <br />
                    <div className = "positionMe"><img src = {gizmodo} height = "42" width = "30" alt = "arrow" className = "logoStat"></img> <h1 className = "text text-blue-lighter">{String(this.state.Gizmodo * 10).slice(0,5)}</h1></div>
                    <br />
                    <div className = "positionMe"><img src = {BI} height = "42" width = "30" alt = "arrow" className = "logoStat"></img> <h1 className = "text text-blue-lighter">{String(this.state.businessInsider * 10).slice(0,5)}</h1></div>
                    </div>
                    </center> 
                </div>
