...
const Sources = () => {
    ...
    return (
        <div className="socialPadding">
            <a className="resp-sharing-button__link" href={`https://facebook.com/sharer/sharer.php?u=http%3A%2F%2F${currentLocation}`} target="_blank" rel="noopener noreferrer" aria-label="">
            ...
            <a className="resp-sharing-button__link" href={`https://reddit.com/submit/?url=http%3A%2F%2F${currentLocation}`} resubmit="true" title="Brought%20to%20you%20by%20MonkeySeeMonkey.news%20" target="_blank" rel="noopener noreferrer" aria-label="">
